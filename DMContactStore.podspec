#
#  Be sure to run `pod spec lint DMContactStore.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/YRDGroup/DMContactStore.git", :tag => "#{s.version}" }
